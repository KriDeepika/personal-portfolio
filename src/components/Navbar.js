    ...
    >
      <div>
        <HashLink smooth to="#home" className="link-item" ref={link1Ref}>
          {footerNav ? "Go To Top" : "Kumari Deepika"}
        </HashLink>
      </div>
      <ul className="links flex flex-col gap-2">
        ...
        <li>
          <HashLink smooth to="#education" className="link-item" ref={link2Ref}>
            Education
          </HashLink>
        </li>
        <li>
        ...
        <li>
          <a
            href="https://drive.google.com/file/d/1ANKyRG0SL_mEEs4s-YoGRlsHFsR8dtKi/view?usp=drive_link"
            target="_blank"
